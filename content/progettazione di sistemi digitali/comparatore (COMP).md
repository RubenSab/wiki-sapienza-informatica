...
> Se $a$ e $b$ sono più lunghi di 1 bit e bisogna necessariamente sapere se $a>b$ o $a<b$ (non solo se $a=b$), allora devo convertire entrambe le variabili in [[complemento a 2 (CA2)]] e eseguire $a-b$ in un [[addizionatori (adder)|adder]] e usare il MSB del risultato:
