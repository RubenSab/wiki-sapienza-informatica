...
---
> Secondo l'[[architettura di Von Neumann]], la **Central Processing Unit** è una [[automa a stati finiti (DFA)|macchina sequenziale]] che estrae le [[assembly RISC-V|istruzioni]] del programma dalla [[memoria]] e le interpreta per mezzo della [[CU (Control Unit)]], la quale dirige gli altri componenti, che a loro volta le eseguono.
