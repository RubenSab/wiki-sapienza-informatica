...
> N.B.: In RISC-V, la memoria è organizzata con **indirizzamento al byte**, ovvero ogni indirizzo di memoria identifica **un singolo byte**. Tuttavia, poiché una **word** in RISC-V a 32 bit è formata da **4 byte**, due word consecutive in memoria si trovano a **4 indirizzi di distanza**.
