...
> Non è sempre possibile risolvere un data hazard direttamente con il forwarding, ma a volte è necessario inserire un'*attesa* (detta anche *stallo* o *bubble*).
