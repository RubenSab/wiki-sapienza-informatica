...
> Un grafo è 2-colorabile se e solo se non contiene cicli di lunghezza dispari, perché due vertici connessi da un ciclo di lunghezza dispari avrebbero lo stesso colore; d'altra parte, se il grafo non ha cicli dispari, è possibile colorarlo con due colori, alternandoli lungo una [[DFS (algoritmo della visita in profondità)|DFS]].
